...
| 操作 | Gas 消耗 | 优化后 | 节省 | 说明 |
|------|---------|--------|------|------|
| **placeLimitOrder** | 246,098 | **197,431** | **48,667 (19.8%)** | 用户下单到 Sequencer |
| **batchProcessRequests (10订单)** | 12,054 总计 | 12,054 总计 | 0 | Matcher 批量处理 10 个订单 |
| **平均每订单 (批量)** | 1,205 | 1,205 | 0 | 批量处理时的平均 gas |
